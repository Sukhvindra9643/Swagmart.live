...
import { clearErrors, createSellerProduct } from "../../actions/productAction";
...
const NewProduct = ({ history }) => {
  ...
  const createProductSubmitHandler = (e) => {
    ...
    dispatch(createSellerProduct(myForm));
  };
      ...
      <div className="dashboard">
        ...
        <div className="newProductContainer">
          ...
          >
            ...
            <div>
              <AccountTreeIcon />
              <select onChange={(e) => setPopularity((e.target.value).toLowerCase())}>
